get_priorities() {
  ...
  for i in $(seq 0 $((days_to_process-1))); do
    ...
    note_instructions='Ohjeistus muistiipanolle, johon kirjoitat priorisoinnit (noudata tarkkaan!):\n
      ...
      - Kerro listojen lopuksi omat huomiosi, tehtävien suorittamiseen kuluva kokonaisaika selkokielisessä muodossa (esim. x tuntia, y minuuttia) ja mahdolliset muut huomiot. Älä unohda, että olen iltavirkku, heräisin mielelläni klo 9-10, minun on nukuttava vähintään 8 tuntia 15 minuuttia, joten kerro myös, milloin minun tulisi aloittaa iltarauhoittuminen ja milloin minun ei pitäisi tehdä vireyttä lisäävää tekemistä. Älä ajoita tehtäviä välille 00-10.\n'
