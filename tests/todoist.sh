...
fetch_tasks() {
  ...
  # Print task total amount for testing and remove the empty spaces before the amount
  echo -e "${BOLD}${GREEN}Total tasks fetched: $(echo "$day_tasks" | wc -l | xargs)${RESET}"
